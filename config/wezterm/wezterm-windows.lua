...
config.keys = {
  -- Ctrl-Backspace → send ESC DEL (\x1b\x7f = Alt-Backspace).
  -- Zsh emacs mode maps \e\x7f to backward-kill-word by default, and the
  -- sequence passes through Zellij transparently without KKP negotiation.
